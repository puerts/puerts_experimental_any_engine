...
V8_INLINE UScriptStruct* GetScriptStructInCoreUObject(const TCHAR* Name)
{
...
{
public:
    V8_INLINE static void* MakeAddressWithHighPartOfTwo(void* Address1, void* Address2)
    {
    ...
    V8_INLINE static void SplitAddressToHighPartOfTwo(const void* Address, UPTRINT& High, UPTRINT& Low)
    {
    ...
    template <typename T>
    V8_INLINE static T* GetPointerFast(v8::Local<v8::Object> Object, int Index)
    {
        int P1 = Index << 1;
        int P2 = P1 + 1;
    ...
    template <typename T>
    V8_INLINE static T* GetPointerFast(v8::Local<v8::Object> Object)
    {
    ...
    V8_INLINE static void SetPointer(v8::Isolate* Isolate, v8::Local<v8::Object> Object, const void* Ptr, int Index)
    {
    ...
    V8_INLINE static v8::Local<v8::ArrayBuffer> NewArrayBuffer(v8::Local<v8::Context> Context, void* Data, size_t DataLength)
    {
...
// #endif
    ...
    V8_INLINE static void* GetArrayBufferData(v8::Local<v8::ArrayBuffer> InArrayBuffer)
    {
        size_t DataLength;
        return GetArrayBufferData(InArrayBuffer, DataLength);
    }

    V8_INLINE static void* GetArrayBufferData(v8::Local<v8::ArrayBuffer> InArrayBuffer, size_t& DataLength)
    {
#if defined(HAS_ARRAYBUFFER_NEW_WITHOUT_STL)
