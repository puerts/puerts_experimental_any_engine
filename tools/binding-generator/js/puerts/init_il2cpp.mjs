...
puer.getGenericMethod = function (csType, methodName, ...genericArgs) {
    ...
    let createOverloadFunctionWrap = function (method) {
        ...
        for (let i = 0; i < paramDefs.Length; i++) {
            ...
            if (paramDef.IsOut)
                argFlags[i] = ((_a = argFlags[i]) !== null && _a !== void 0 ? _a : 0) | ARG_FLAG_OUT;
            if (paramType.IsByRef) {
                argFlags[i] = ((_b = argFlags[i]) !== null && _b !== void 0 ? _b : 0) | ARG_FLAG_REF;
        ...
        let checkArgs = function (...args) {
            if (needArgCount != (args ? args.length : 0))
                return GENERIC_INVOKE_ERR_ARG_CHECK_FAILED;
            if (needArgCount == 0)
                return null;
            argsCsArr = argsCsArr !== null && argsCsArr !== void 0 ? argsCsArr : CS.System.Array.CreateInstance(typeof_System_Object, needArgCount);
            // set args to c# array
